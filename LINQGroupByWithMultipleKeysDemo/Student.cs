    ...
    public class Student
    {
        ...
        public static List<Student> GetStudents()
        {
            return new List<Student>
            {
                ...
                new Student
                {
                    ID = 1002, Name = "Snurag", Gender = "Male",
                    Barnch = "ETC", Age = 21
                },
                new Student
                {
                    ID = 1003, Name = "Pranaya", Gender = "Male",
                    Barnch = "CSE", Age = 21
                },
                new Student
                {
                    ID = 1004, Name = "Anurag", Gender = "Male",
                    Barnch = "CSE", Age = 20
                },
                new Student
                {
                ...
                new Student
                {
                    ID = 1007, Name = "santosh", Gender = "Male",
                    Barnch = "CSE", Age = 22
                },
                new Student
                {
                ...
                new Student
                {
                    ID = 1010, Name = "Sambit", Gender = "Male",
                    Barnch = "ETC", Age = 21
                }
            };
        }
