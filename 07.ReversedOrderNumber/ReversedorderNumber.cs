...
namespace _07.ReversedOrderNumber
{

    using System;

    internal class ReversedorderNumber
    {
        private static void ReverseTheorderOfANumber(decimal number)
        {
            //return decimal.Parse(new string(number.ToString().ToCharArray().Reverse().ToArray<char>()));
        ...
        private static void Main()
        {
            ...
            ReverseTheorderOfANumber(number);
        }
